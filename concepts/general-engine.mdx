...
The General Engine is the default MemoryOS runtime. Use it when your product needs reliable long-term memory but does not require an industry-specific schema.
...
Stay on the General Engine if prompt-ready memory is sufficient.
