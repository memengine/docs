...
`agent_id` must be the UUID returned by agent registration. Malformed IDs
return `422`; a valid UUID with no active public agent returns `404`.
...
```json
{
  ...
  "timestamp": "2026-09-11T17:32:37Z"
}
```
...
```text
https://consent.memoryo.dev/connect?agent_id=aa535a7e-b0d6-44df-8e17-8438f6098836&link_token=plink_...
```
