...
If your tenant has a domain schema enabled, such as EdTech, the same SDK calls below still apply. Domain extraction and domain-aware retrieval happen inside MemoryOS. See [Domain schemas](/concepts/domain-schemas) and the [EdTech cookbook](/guides/edtech-domain).
